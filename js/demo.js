  ...
  class HoverImgFx13 {
    ...
    position() {
      ...
      this.DOM.reveal.style.top = `${
        this.rect.top - this.DOM.reveal.offsetHeight / 2
      }px`;
      this.DOM.reveal.style.left = `${
        this.rect.left - this.DOM.reveal.offsetWidth / 2
      }px`;
    }
    initEvents() {
      this.mouseenterFn = () => {
  ...
  class HoverImgFx16 {
    ...
    initEvents() {
      this.positionElement = (ev) => {
        ...
        this.DOM.reveal.style.top = `${
          mousePos.y - this.rect.height - 20 - docScrolls.top
        }px`;
        this.DOM.reveal.style.left = `${
          mousePos.x - this.rect.width - 20 - docScrolls.left
        }px`;
      };
      this.mouseenterFn = (ev) => {
        this.positionElement(ev);
    ...
    showImage() {
      ...
      for (let i = 0; i <= this.totalImages - 1; ++i) {
        TweenMax.set(this.DOM.revealImgs[i], {
          ...
          rotation: `${
            i !== this.totalImages - 1 ? getRandomFloat(-5, 5) : 0
          }deg`,
        });
    ...
    showImage() {
      ...
      for (let i = 0; i <= this.totalImages - 1; ++i) {
        TweenMax.set(this.DOM.revealImgs[i], {
          ...
          rotation: `${
            i !== this.totalImages - 1 ? -1 + 3 * (this.totalImages - i - 1) : 0
          }deg`,
    ...
    showImage() {
      ...
      for (let i = 0; i <= this.totalImages - 1; ++i) {
        TweenMax.set(this.DOM.revealImgs[i], {
          ...
          rotation: `${
            i !== this.totalImages - 1 ? getRandomFloat(-7, 7) : 0
          }deg`,
